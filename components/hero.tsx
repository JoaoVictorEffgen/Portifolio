...
export function Hero({ profile }: { profile: GithubProfile | null }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col justify-center px-4 py-20 sm:px-6 lg:py-28">
        <p className="inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium tracking-wide text-primary uppercase">
